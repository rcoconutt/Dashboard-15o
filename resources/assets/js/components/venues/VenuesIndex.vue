    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <form action="/venues/action" method="POST" id="form">
                    <input type="hidden" name="_token" v-model="csrf">
                    <div class="row flex-row-reverse">
                        <div class="col-md-4 first col-sm-12 text-right">
                            <a class="btn btn-block btn-mdb-color" href="/venues/create">Crear centro</a>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <select name="actions" id="actions" class="form-control" style="margin-top: 3px;">
                                        ...
                                        <option value="1">Activar centros</option>
                                        <option value="2">Desactivar centros</option>
                                    </select>
                                </div>
                                <div class="col-4">
                    ...
                    <hr>
                    <table id="centros" class="table table-bordered dt-responsive" style="width:100%">
                        <thead>
                        <tr>
                            <th></th>
                            <th>Zona</th>
            ...
            getCentros: function () {
                $('#centros').DataTable({
                    ...
                    columns: [
                        ...
                        {
                            data: 'ID_CENTRO', render: function (data, type, row, meta) {
                                return "<a class='btn btn-link btn-sm waves-effect text-primary' href='/venues/" + data + "'>Editar</a></div>";
                            }
                        },
                    ],
                    language: {
                    ...
                    if (numberOfChecked > 0) {
                        if (value == 3) {
                            swal({
                                ...
                                text: "Realmente deseas eliminar las centros seleccionadas",
                                icon: "error",
                        ...
                        swal({ title: "", text: "Selecciona al menos un centro", button: "Entendido" });
                    }
                })
            });
        }
